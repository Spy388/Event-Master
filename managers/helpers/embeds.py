...
class Embeds(object):
    ...
    color_info = discord.Colour(16514816) #fbff00 - yellow
    ...
    def add_footer(embed, execution_time):
        ...
        embed.set_footer(text="Bot by @BlueX/@spyagent388 {0}".format(execution_time_str), icon_url="https://discord.com/assets/2c21aeda16de354ba5334551a883b481.png")
